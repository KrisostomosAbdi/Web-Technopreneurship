...
<body>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle2">"Customization freedom in diversity"</p>
							<h1>WELCOME TO</h1>
							<h1><span class="orange-text">BOMBOM</span> RELIGY SHOP</h1>
							<div class="hero-btns">
								<a href="login1/login.php" class="boxed-btn">Order Now</a>
								<a href="loginseller/login.php" class="bordered-btn">Login as Seller</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<a href="login1/login.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Order Now</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
	...
	<section class="shop-banner">
		<div class="container">
			...
			<a href="login1/login.php" class="cart-btn btn-lg">Shop Now</a>
		</div>
	</section>
	<!-- end shop banner -->
